...
export interface ApiMovieMovie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::movie.movie'> &
      Schema.Attribute.Private;
    logline: Schema.Attribute.Text;
    movieStatus: Schema.Attribute.Enumeration<
      [
        'In Development',
        'Pre-Production',
        'Production',
    ...
    posterLabel: Schema.Attribute.String;
    producers: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiZoneZone extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    billboards: Schema.Attribute.Relation<
      'oneToMany',
      'api::billboard.billboard'
    >;
    createdAt: Schema.Attribute.DateTime;
